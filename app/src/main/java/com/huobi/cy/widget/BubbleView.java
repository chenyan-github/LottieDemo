...
import com.huobi.cy.mockitodemo.R;
    ...
    private void initView(AttributeSet attrs) {
        if (attrs != null) {
            ...
            mAngle = (int) a.getDimension(
                    R.styleable.BubbleView_bubble_angle, mAngle);
            mArrowHeight = (int) a.getDimension(
                    R.styleable.BubbleView_bubble_arrowHeight,
                    mArrowHeight);
            mArrowOffset = (int) a.getDimension(
                    R.styleable.BubbleView_bubble_arrowOffset,
                    mArrowOffset);
            mArrowTop = (int) a.getDimension(
                    R.styleable.BubbleView_bubble_arrowTop, mArrowTop);
            mArrowWidth = (int) a.getDimension(
                    R.styleable.BubbleView_bubble_arrowWidth, mAngle);
            mArrowLocation = a.getInt(
                    R.styleable.BubbleView_bubble_arrowLocation,
                    mArrowLocation);
            a.recycle();
        }
    }
